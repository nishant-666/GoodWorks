    ...
    return (
      ...
      >
        ...
        <Modal basic open={modal} onClose={this.closeModal}>
          ...
          <Modal.Actions>
            <Button color="green" style={{fontFamily:'Poppins'}} inverted onClick={this.handleSaveColors}>
              <Icon name="checkmark" /> Save Colors
            </Button>
            <Button color="red" style={{fontFamily:'Poppins'}} inverted onClick={this.closeModal}>
